/*
 * Breach: [mod_strip_advanced] strip.js
 *
...
var strip = function(spec, my) {
  ...
  shortcut_go = function() {
    breach.module('mod_strip_advanced').call('box_select_all');
  };
  ...
  init = function(cb_) {
    async.series([
      function(cb_) {
        ...
        breach.module('mod_strip_advanced').on('box_load_url', box_load_url_handler);
        breach.module('mod_strip_advanced').on('box_input', box_input_handler);
